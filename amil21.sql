...
--
-- Client: localhost
-- Généré le: Lun 21 Avril 2014 à 21:12
...
INSERT INTO `membre` (`id_membre`, `mail`, `pseudo`, `ip`, `prenom`, `nom`, `age`, `autorisation`, `activites`, `photo`, `mdp`, `fiches_lues`, `sexe`) VALUES
(1, '', 'ps_franck1', '', '', 'franck1', 0, 0, '', NULL, 'AQ1', '', 0),
(2, '', 'ps_franck2', '', '', 'franck2', 0, 0, '', NULL, 'AQ2', '', 0),
(3, 'test@ta.fr', 'ps_franck1', '', '', '', 0, 0, '', NULL, 'azer', '', 0),
(4, 'test1@ta.fr', 'aze', '', '', '', 0, 0, '', NULL, 'azer', '', 0),
(5, 'test2@hk.com', 'azer', '', '', '', 0, 0, '', NULL, '&é"''', '', 0),
(6, 'kjhgkjj@jkjh.com', 'tests', '', '', '', 0, 0, '', NULL, 'vbn', '', 0),
(7, 'kjhgkjj@jkjh.com', 'tests', '', '', '', 0, 0, '', NULL, 'vbn', '', 0),
(8, 'hll@kjl.com', 'gkgkk', '', '', '', 0, 0, '', NULL, 'hjk', '', 0),
(9, 'ljl@yahoo.fr', 'jjl', '', '', '', 0, 0, '', NULL, 'mdp', '', 0);
...
CREATE TABLE IF NOT EXISTS `organisation` (
  ...
  `mail_secretaire` varchar(100) NOT NULL,
  ...
  `departement` enum('06','83') NOT NULL,
...
INSERT INTO `organisation` (`id_orga`, `nom_orga`, `nom_president`, `mail_president`, `tel_president`, `mail_secretaire`, `nom_secretaire`, `adresse`, `presentation`, `mdp`, `login`, `ville`, `departement`, `logo`) VALUES
(1, 'fsju', '', 'jojo@yahoo.fr', '0606060606', 'WEB@JLK.COM', '0', '2 rue ljm', 'notre organisation a pour but de mjl:hlqnxlX/M<\r\n<QKJ<BXJ<CXB;\r\nXKJqkjqkjxkqx;nhwlnclkds:njq:qjq ncqljq', 'az', 'az1', 'nice', '06', ''),
(2, 'bne brit\r\n', '', '', '', '', '0', '', '', 'az', 'az2', '', '', ''),
(3, 'toto', 'jjljl', '', '', 'ljuli@ol.com', '', '12 rue albert jarry', 'encore uen presentation!', 'wxc', '', 'toulon', '', '');
