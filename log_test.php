...
if (isset($_GET['pseudo'])){
	...
	if (!empty($result)) {		// si il y a une reponse, c'est que celui qui a cliqué est un membre
   		if ($result[0]['mdp'] == $_POST['mdp']) {		// ici on verifie qu'alors son mdp est le bon
